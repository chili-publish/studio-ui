...
describe('FontSizeConstraint', () => {
    ...
    it('should call textSelection.set when value changes', async () => {
        const selectedTextStyle: SelectedTextStyle = {
            fontSize: 16,
        } as SelectedTextStyle;
        ...
        const input = screen.getByTestId(getDataTestIdForSUI('font-size-constraint'));
    ...
    it('should handle comma-separated decimal values', async () => {
        ...
        // Simulate typing a value with comma as decimal separator
        await user.clear(input);
        ...
        await waitFor(() => {
            expect(mockSDK.textSelection.set).toHaveBeenCalledWith({
                [SelectedTextStyles.FONT_SIZE]: { value: 18.5 },
            });
        });
    });

    it('plus button should be disabled when max value is reached', async () => {
        const selectedTextStyle: SelectedTextStyle = {
            fontSize: 15,
        } as SelectedTextStyle;
    ...
    it('minus button should be disabled when min value is reached', async () => {
        const selectedTextStyle: SelectedTextStyle = {
            fontSize: 15,
        } as SelectedTextStyle;
    ...
    it('falls back to previous value when user enters a value lower than the min value', async () => {
        const selectedTextStyle: SelectedTextStyle = {
            fontSize: 15,
        } as SelectedTextStyle;
