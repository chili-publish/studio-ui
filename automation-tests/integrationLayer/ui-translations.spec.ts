...
test.describe('Toolbar UI translations', () => {
    const projectConfig = { ...getProjectConfig({ uiTranslations: uiTranslations.toolbar, sandboxMode: true }) };
    test.use({ projectConfig });
    test('should apply toolbar translations', async ({ page }) => {
...
test.describe('Layouts UI translations', () => {
    const projectConfig = { ...getProjectConfig({ uiTranslations: uiTranslations.layouts, sandboxMode: true }) };
    test.use({ projectConfig });
    test('should apply layouts translations', async ({ page }) => {
        await expect(page.locator('#studio-ui-chili-editor').first()).toBeVisible();
...
test.describe('Variables UI translations', () => {
    const projectConfig = { ...getProjectConfig({ uiTranslations: uiTranslations.variables, sandboxMode: true }) };
    test.use({ projectConfig });
    test('should apply variables translations', async ({ page }) => {
        await expect(page.locator('#studio-ui-chili-editor').first()).toBeVisible();
...
test.describe('Datasource UI translations', () => {
    const projectConfig = { ...getProjectConfig({ uiTranslations: uiTranslations.datasource, sandboxMode: true }) };
    test.use({ projectConfig });
    test('should apply datasource translations', async ({ page }) => {
        await expect(page.locator('#studio-ui-chili-editor').first()).toBeVisible();
